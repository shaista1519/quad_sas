...
Protoplus.ui = {
    ...
    spinner: function(element, options){
        ...
        spinnerTable.setStyle({border:'1px solid #ccc', display:'inline-block', background:'#fff', maxWidth:'180px', position:'relative', width:spinnerTableWidth, paddingRight:'20px', boxSizing:'border-box' });
